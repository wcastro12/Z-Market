...
namespace Z_Market.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeId,FirstName,LastName,Salary,BonusPercent,DateofBirth,StratTime,Email,URL,DocumentTypeId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeId,FirstName,LastName,Salary,BonusPercent,DateofBirth,StratTime,Email,URL,DocumentTypeId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
